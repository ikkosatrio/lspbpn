                    ...
                    <div class="news-1-box clearfix">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 top30">
                            ...
                            <div class="news-details bottom10">
                                ...
                                <a href="{{route('news', ['category'=>$news->Category->id])}}"><span><i class="fa fa-list-alt"></i> {{$news->Category->title }}</span></a>
                            </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 text-left">
                            <div class="social-icons">
                                ...
                                <ul class="social_share">
                                    <li><a target="_blank" href="{{ $news->ShareFacebook }}" class="facebook"><i class="icon-facebook-1"></i></a></li>
                                    <li><a target="_blank" href="{{ $news->ShareTwitter }}" class="twitter"><i class="icon-twitter-1"></i></a></li>
                                    <li><a data-action="share/whatsapp/share" target="_blank" href="{{ $news->ShareWhatsapp }}" class="whatsapp"><i class="icon-whatsapp"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
