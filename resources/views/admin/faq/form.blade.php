        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formInput" action="{{ ($data['typeForm'] =="create") ? route('admin.faq.store') : route('admin.faq.update',$data['dataModel']->id) }}" method="POST" enctype="multipart/form-data">
                                        
                                
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2">Question</label>
                                    <div class="col-lg-10">
                                        <input type="text" required class="form-control" value="{{ ($data['typeForm'] =="create") ? "" : $data['dataModel']->question }}" placeholder="Question" name="question">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2">Answer</label>
                                    <div class="col-lg-10">
                                        <textarea id="editor" rows="3" cols="3" class="form-control" name="answer" placeholder="">{{ ($data['typeForm'] =="create") ? "" : $data['dataModel']->answer }}</textarea>
                                    </div>
                                </div>
