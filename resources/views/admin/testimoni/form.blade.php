        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formInput" action="{{ ($data['typeForm'] =="create") ? route('admin.testimoni.store') : route('admin.testimoni.update',$data['dataModel']->id) }}" method="POST" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-2">Name</label>
                                            <div class="col-lg-10">
                                                <input type="text" required class="form-control" value="{{ ($data['typeForm'] =="create") ? "" : $data['dataModel']->name }}" placeholder="Name banner" name="name">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-2">Comment</label>
                                            <div class="col-lg-10">
                                                <textarea id="editor" rows="3" cols="3" class="form-control" name="comment" placeholder="Comment">{{ ($data['typeForm'] =="create") ? "" : $data['dataModel']->comment }}</textarea>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" required class="form-control" value="{{ ($data['typeForm'] =="create") ? "" : $data['dataModel']->position }}" placeholder="Position" name="position">
                                    </div>
                                </div>
                                <div class="form-group row">
        ...
        $("#formInput").submit(function(e){
            ...
            .done(function(data){
                ...
                if(data.Code == 200){
                    ...
                    setTimeout(function(){ 
                        redirect('{{route('admin.testimoni.index')}}');
                    }, 2000);
                }else{
