        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formInput" action="{{ ($data['typeForm'] =="create") ? route('admin.cases.store') : route('admin.cases.update',$data['dataModel']->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" required class="form-control" value="{{ ($data['typeForm'] =="create") ? "" : $data['dataModel']->description }}" placeholder="Description" name="description">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2">Youtube Link</label>
                                    <div class="col-lg-10">
                                        <input type="text" required class="form-control" value="{{ ($data['typeForm'] =="create") ? "" : $data['dataModel']->youtube }}" placeholder="Youtube Link" name="youtube">
                                    </div>
                                </div>
        ...
        $("#formInput").submit(function(e){
            ...
            .done(function(data){
                ...
                if(data.Code == 200){
                    ...
                    setTimeout(function(){ 
                        redirect('{{route('admin.cases.index')}}');
                    }, 2000);
                }else{
