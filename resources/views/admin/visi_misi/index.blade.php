                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ ($typeForm =="create") ? "" : route('admin.visi-misi.update',$dataModel->id) }}" id="formInput" enctype="multipart/form-data" action="post">
...
<script>
    $(document).ready(function(){
        ...
        var options = {
            ...
            extraPlugins : 'justify,youtube,colorbutton,panelbutton,button,floatpanel,panel,colordialog,font',
        };
