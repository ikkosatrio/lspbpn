        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formInput" action="{{ ($data['typeForm'] =="create") ? route('admin.kompetensi.detail.store',$data['kopetensi']->id) : route('admin.kompetensi.detail.update',[$data['kopetensi']->id, $data['dataModel']->id]) }}" 
                            method="POST" enctype="multipart/form-data">                
                                
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2">Sort</label>
                                    <div class="col-lg-10">
                                        <input type="number" required class="form-control" value="{{ ($data['typeForm'] =="create") ? "" : $data['dataModel']->sort }}" placeholder="Sort" name="sort">
                                    </div>
                                </div>
        ...
        $("#formInput").submit(function(e){
            ...
            .done(function(data){
                ...
                if(data.Code == 200){
                    ...
                    setTimeout(function(){ 
                        redirect('{{route('admin.kompetensi.detail.index',$data['kopetensi']->id)}}');
                    }, 2000);
                }else{
