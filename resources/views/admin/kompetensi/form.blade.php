        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formInput" action="{{ ($data['typeForm'] =="create") ? route('admin.kompetensi.store') : route('admin.kompetensi.update',$data['dataModel']->id) }}" method="POST" enctype="multipart/form-data">               
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2">Short Content</label>
                                    <div class="col-lg-10">
                                        <textarea id="editorShortContent" rows="3" cols="3" class="form-control" name="short_content" placeholder="">{{ ($data['typeForm'] =="create") ? "" : $data['dataModel']->short_content }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <textarea id="editorContent" rows="3" cols="3" class="form-control" name="content" placeholder="">{{ ($data['typeForm'] =="create") ? "" : $data['dataModel']->content }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" value="{{ ($data['typeForm'] =="create") ? "" : $data['dataModel']->price }}" placeholder="Price" name="price">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" value="{{ ($data['typeForm'] =="create") ? "" : $data['dataModel']->price_discount }}" placeholder="Price Discount" name="Price Discount">
                                    </div>
                                </div>
                                <hr>
                                <div class="form-group row">
...
<script>
    $(document).ready(function(){
        ...
        CKEDITOR.replace('editorShortContent', options);
