        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formInput" action="{{ ($data['typeForm'] =="create") ? route('admin.event.store') : route('admin.event.update',$data['dataModel']->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" required class="form-control datepicker" value="{{ ($data['typeForm'] =="create") ? "" : $data['dataModel']->DateNice }}" placeholder="Date" name="date_event">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2">Content</label>
                                    <div class="col-lg-10">
                                        <textarea id="editor" rows="3" cols="3" class="form-control" name="content" placeholder="">{{ ($data['typeForm'] =="create") ? "" : $data['dataModel']->content }}</textarea>
                                    </div>
                                </div>
