        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formInput" action="{{ ($data['typeForm'] =="create") ? route('admin.gallery-category.store') : route('admin.gallery-category.update',$data['dataModel']->id) }}" method="POST" enctype="multipart/form-data">
