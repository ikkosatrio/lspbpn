                            ...
                            <div class="card-body">
                                <form action="{{ ($typeForm =="create") ? "" : route('admin.config.update',$dataModel->id) }}" id="formInput" enctype="multipart/form-data" action="post">
                                    <fieldset class="mb-3">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-2">Maps Script</label>
                                            <div class="col-lg-10">
                                                <textarea rows="3" cols="3" class="form-control" name="maps_script" placeholder="Body Script">{{ ($typeForm =="create") ? : $dataModel->maps_script }}</textarea>
                                            </div>
                                        </div>
