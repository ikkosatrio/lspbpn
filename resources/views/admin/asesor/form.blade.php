        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formInput" action="{{ ($data['typeForm'] =="create") ? route('admin.asesor.store') : route('admin.asesor.update',$data['dataModel']->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" id="dpExpired" required class="form-control myDatepicker" value="{{ ($data['typeForm'] =="create") ? "" : $data['dataModel']->expired_date }}" placeholder="Expired Date" name="expired_date">
                                    </div>
                                </div>
        ...
        $("#formInput").submit(function(e){
            ...
            .done(function(data){
                ...
                if(data.Code == 200){
                    ...
                    setTimeout(function(){ 
                        redirect('{{route('admin.asesor.index')}}');
                    }, 2000);
                }else{
